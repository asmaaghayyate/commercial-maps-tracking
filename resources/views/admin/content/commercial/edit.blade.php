                    ...
                    <div class="row row-sm">
                                ...
                                <select name="departement_id" class="form-control SlectBox SumoUnder">
                                    @foreach ($departements as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('departement_id', $commercial->departement_id) == $item->name ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <select name="type_deplacement" class="form-control SlectBox SumoUnder">
                                    ...
                                    <option
                                        {{ old('type_deplacement', $commercial->type_deplacement) == 'car' ? 'selected' : '' }}
                                        value="car">Car
                                    </option>
                                    <option
                                        {{ old('type_deplacement', $commercial->type_deplacement) == 'bike' ? 'selected' : '' }}
                                        value="bike">Bike
                                    </option>
                                    <option
                                        {{ old('type_deplacement', $commercial->type_deplacement) == 'public_transport' ? 'selected' : '' }}
                                        value="public_transport">Public Transport</option>
                                    <option
                                        {{ old('type_deplacement', $commercial->type_deplacement) == 'Walking' ? 'selected' : '' }}
                                        value="walking">
                                        Walking</option>
                                </select>
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <select name="genre" class="form-control SlectBox SumoUnder">
                                    ...
                                    <option {{ old('genre', $commercial->genre) == 'homme' ? 'selected' : '' }}
                                        value="homme">Homme
                                    </option>
                                    <option {{ old('genre', $commercial->genre) == 'femme' ? 'selected' : '' }}
                                        value="femme">femme
                                    </option>
                                </select>
                                @error('type_deplacement')
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <select name="type_contrat" class="form-control SlectBox SumoUnder">
                                    ...
                                    <option
                                        {{ old('type_contrat', $commercial->type_contrat) == 'stage' ? 'selected' : '' }}
                                        value="stage">stage
                                    </option>
                                    <option
                                        {{ old('type_contrat', $commercial->type_contrat) == 'travaille' ? 'selected' : '' }}
                                        value="travaille">
                                        travaille
                                    </option>
                                </select>
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="identite" placeholder="Enter identite" required
                                    value="{{ old('identite', $commercial->identite) }}" type="text" />
                                @error('identite')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mg-b-0">
                                ...
                                <textarea name="adresse" class="form-control" id="" cols="30" rows="10">{{ old('identite', $commercial->adresse) }}</textarea>
                                @error('adresse')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="date_debut" placeholder="Enter identite" required
                                    value="{{ old('date_debut', $commercial->date_debut) }}" type="date" />
                                @error('date_debut')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mg-b-0">
                                ...
                                <input class="form-control" name="date_fin" placeholder="Enter date fin" required
                                    value="{{ old('date_fin', $commercial->date_fin) }}" type="date" />
                                @error('date_fin')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
